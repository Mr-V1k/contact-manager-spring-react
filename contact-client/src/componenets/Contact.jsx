        ...
        <Link to={`/contacts/${contact.id}`} className="contact__item">
            <div className="contact__header">
                ...
                <div className="contact__details">
                    <p className="contact_name">{contact.name.slice(" ")} </p>
                    <p className="contact_title">{contact.occupation}</p>
                </div>
            </div>
            <div className="contact__body">
                ...
                <p>
                    {
                        contact.status.toLowerCase() === "active" ? <i className='bi bi-check-circle'></i>
