package dev.v1k.contactapi.controller;

import dev.v1k.contactapi.domain.Contact;
import dev.v1k.contactapi.service.ContactService;
...
public class ContactController {
    ...
    public ResponseEntity<Contact> createContact(@RequestBody Contact contact){
       return ResponseEntity.created(URI.create("userID")).body(contactService.createContact(contact));
    }
    @DeleteMapping("{id}")
